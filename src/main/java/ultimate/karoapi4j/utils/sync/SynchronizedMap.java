...
/**
 * Base for synchronized maps managing the most relevant access operations.<br>
 * Note:<br>
 ...
 */
public class SynchronizedMap<K, V, M extends Map<K, V>, S extends SynchronizedMap<K, V, M, S>> extends BaseSynchronized<Map<K, V>, S> implements
		Map<K, V>, Synchronized<Map<K, V>, S>
{
	...
	{
		super((Loader<Map<K, V>>) loader, refreshMode);
		this.map = map;
	}
