...
public class RulesTest
{
	...
	public void test_createOptions(double preferStandards) throws InterruptedException, ExecutionException
	{
		logger.info("--------------------------------------------------");
		...
		{
			options = rules.createOptions(random, preferStandards);
